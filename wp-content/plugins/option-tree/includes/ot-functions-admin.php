...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  $array3 = array(
      ...
      array(
        'value'   => 'header4',
        'label'   => __( 'Header 4', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/header-4.png'
      )
    );
  $array4 = array(
      array(
  ...
  $array5 = array(
      array(
        'value'   => 'menu-1',
        'label'   => __( 'Header 1', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/menu-1.png'
      ),
      array(
        'value'   => 'menu-2',
        'label'   => __( 'Header 2', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/menu-2.png'
      ),
    );
    ...
    elseif($field_id == 'mobile-menu-layout')
      return apply_filters( 'ot_radio_images', $array5 ,$field_id );
  }
