...
class Booked_WC_EnqueueScript {
	...
	public function add_js_variables() {
		...
		$js_variables_array = array(
			...
			'i18n_confirm_appt_edit' => __('Are you sure you want to change the appointment date? By doing so, the appointment date will need to be approved again.', 'wyzi-business-finder'),
			'i18n_pay' => __('Are you sure you want to add the appointment to cart and go to checkout?', 'wyzi-business-finder'),
			'i18n_mark_paid' => __('Are you sure you want to mark this appointment as "Paid"?', 'wyzi-business-finder'),
			'i18n_paid' => __('Paid', 'wyzi-business-finder'),
			'i18n_awaiting_payment' => __('Awaiting Payment', 'wyzi-business-finder'),
