...
class Booked_WC_WP_Crons {
	...
	public static function cron_schedules( $schedules ) {
		$schedules['weekly'] = array(
			'interval' => 60 * 60 * 24 * 7,
			'display' => __('Weekly', 'wyzi-business-finder')
		);

		$schedules['twiceweekly'] = array(
			'interval' => 60 * 60 * 24 * 3.5,
			'display' => __('Twice Weekly', 'wyzi-business-finder')
		);

		$schedules['monthly'] = array(
			'interval' => 60 * 60 * 24 * 30.5,
			'display' => __('Monthly', 'wyzi-business-finder')
		);

		$schedules['twicemonthly'] = array(
			'interval' => 60 * 60 * 24 * 15,
			'display' => __('Twice Monthly', 'wyzi-business-finder')
		);

		$schedules['twicehourly'] = array(
			'interval' => 60 * 30,
			'display' => __('Every 30 Minutes', 'wyzi-business-finder')
		);
		
		$schedules['everyfifteen'] = array(
			'interval' => 60 * 15,
			'display' => __('Every 15 Minutes', 'wyzi-business-finder')
		);
		
		$schedules['everyfive'] = array(
			'interval' => 60 * 5,
			'display' => __('Every 5 Minutes', 'wyzi-business-finder')
		);
